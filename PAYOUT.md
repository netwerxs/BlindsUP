...
The per-payout and House **bill breakdowns** ("which bills to set aside") only
appear when the counted cash covers every payout exactly. If any payout would
need change, all the bill breakdowns are hidden — the dollar figures still
show.

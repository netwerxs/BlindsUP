...
- **29 blind levels** — 100/200 through 18000/36000, automatically sequenced
...
|--------|--------|-----------|----------|
| 1–5 | 100/200 → 500/1000 | +100/+200 per level | 15 min each |
...
| 14–29 | 3000/6000 → 18000/36000 | +1000/+2000 per level | 10 min each |

On the timer screen the blind pair auto-shrinks to fit when a wide value (e.g. `18000 / 36000`) would overflow.
